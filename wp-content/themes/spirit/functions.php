...
function spirit_scripts() {
  ...
  wp_enqueue_style('favicon',get_template_directory_uri() . '/img/favicon.ico');
	wp_enqueue_style('app1',get_template_directory_uri() . '/img/apple-touch-icon.png');
	wp_enqueue_style('app2',get_template_directory_uri() . '/img/apple-touch-icon-72x72.png');
	wp_enqueue_style('app3',get_template_directory_uri() . '/img/apple-touch-icon-114x114.png');
	wp_enqueue_style('bootstrap',get_template_directory_uri() . '/css/bootstrap.css');
	wp_enqueue_style('fontA',get_template_directory_uri() . '/fonts/font-awesome/css/font-awesome.css');
	...
	wp_enqueue_style('css1',get_template_directory_uri() . '/css/style.css');
	wp_enqueue_style('css2',get_template_directory_uri() . '/css/responsive.css');
	wp_enqueue_style('link1','http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic');
	wp_enqueue_style('link2','http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,700,300,600,800,400');
 ...
 wp_enqueue_script('ajax',"https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js",[],"",true);
 wp_enqueue_script('jquery',get_template_directory_uri() . "/js/jquery.1.11.1.jss",[],"",true);
 wp_enqueue_script('bootstr',get_template_directory_uri() . "/js/bootstrap.js",[],"",true);
 wp_enqueue_script('smooth',get_template_directory_uri() . "/js/SmoothScroll.js",[],"",true);
 wp_enqueue_script('jquery2',get_template_directory_uri() . "/js/jquery.isotope.js",[],"",true);
 wp_enqueue_script('owl',get_template_directory_uri() . "/js/owl.carousel.js",[],"",true);
...
add_action( 'init', 'custom_post_types', 4 );



function create_target_shortcode(){
	return "<span class='fa fa-dot-circle-o'></span>";
}

add_shortcode('target','create_target_shortcode');



add_image_size('about', 708, 600, true);
/**
